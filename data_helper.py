...
from dataset import _dataset_info, JigSawDataset, JigsawTestDataset
...
def get_train_dataloader(args, txt_file):
    ...
    loader = torch.utils.data.DataLoader(
        train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=4, pin_memory=True, drop_last=True)
...
def get_val_dataloader(args, txt_file):
    ...
    loader = torch.utils.data.DataLoader(
        test_dataset, batch_size=1, shuffle=False, num_workers=4, pin_memory=True, drop_last=False)
...
def get_train_transformers(args):
    ...
    img_tr = img_tr + [transforms.ToTensor(), transforms.Normalize([0.485,
