...
def get_optim_and_scheduler(feature_extractor, rot_cls, obj_cls, center_loss, epochs, lr, train_all):
    """
    ...
    if train_all:
        params = list(feature_extractor.parameters()) + list(rot_cls.parameters()
                                                             ) + list(obj_cls.parameters()) + list(center_loss.parameters())
    else:
        params = list(rot_cls.parameters()) + \
            list(obj_cls.parameters()) + list(center_loss.parameters())
